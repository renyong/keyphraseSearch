...
var searchbox = angular.module('atilika.search.searchbox', [
]);

searchbox.directive('atilikaSearchbox', ['$rootScope', 'dbconfig', 'searchHandler', 'solr','$http',
    function($rootScope, dbconfig, searchHandler, solr,$http) {
        return {
            ...
            templateUrl: 'module/searchbox/searchbox-template.html'
        };
    }
]);
